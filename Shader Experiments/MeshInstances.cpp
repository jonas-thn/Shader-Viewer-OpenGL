...
void MeshInstances::Translate(glm::vec3 pos)
{
	model = glm::translate(model, pos);
}

void MeshInstances::SetPos(glm::vec3 pos)
{
	model = glm::translate(glm::mat4(1.0f), pos);
}

void MeshInstances::Rotate(float angle, const glm::vec3& axis)
{
	model = glm::rotate(model, glm::radians(angle), axis);
}

void MeshInstances::RotateWorld(float dx, float dy, float sensitivity)
{
...
void MeshInstances::SetScale(glm::vec3 scale)
{
...
void MeshInstances::Draw(Shader& shader, glm::mat4& view, glm::mat4& projection, glm::vec3& camPos, float time, std::vector<glm::vec3>& offsets, int count) const
{
	...
	{
		shader.SetVec3("offsets[" + std::to_string(i) + "]", offsets[i]);
	}
...
void MeshInstances::ProcessNode(aiNode* node, const aiScene* scene)
{
...
void MeshInstances::ProcessMesh(aiMesh* mesh, const aiScene* scene)
{
